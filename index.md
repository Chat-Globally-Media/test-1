...
<head>
    ...
    <title>Spend Jeff Bezos Money (Billionaires)</title>
    <meta name="description" content="This website lets you spend a billionaires money. For example, our game puts how much money Jeff Bezos has into perspective">
...
<!--            <img src="static/bezos.jpg" style="border-radius: 50%; width: 120px; height: 120px;">-->
<!--            <h1 style="font-size: 30px; margin-top: 1em; text-shadow: 1.1px 1.1px white;">Spend Jeff Bezos' Money</h1>-->
<!--            <p>Bezos is the richest man in the world with a network of <b>124.7 Billion</b><br>Spend his money with our TikTok video inspired <br>website where you can cash out on your biggest desires</p>-->
            ...
            <div class="mainbox2">
                ...
                <div class="bg-dark" id="nomargin" style="margin-top: 1em;">
                    <div style="margin-top: 1em; margin-bottom: 1em;">
                        ...
                        <p style="font-weight: bold;">Luxury Vehicle</p>
...
<!--                <div class="bg-dark" id="margin" style="margin-top: 1em;">-->
<!--                    <div style="margin-top: 1em; margin-bottom: 1em;">-->
<!--                        <img src="static/tesla.png" style="height: 50%;">-->
<!--                        <p style="font-weight: bold;">Tesla</p>-->
<!--                        <p style="color: limegreen; font-weight: bold; font-size: 19px;">$70000</p>-->
<!--                    </div>-->
<!--                    <div style="margin-top: 1em; margin-bottom: 1em;">-->
<!--                        <button class="btn btn-success" style="float: left; margin-left: 7%;">Buy</button>  <button class="btn btn-danger" style="float: right; margin-right: 7%;">Sell</button> <center><input value=0 style="max-width: 100px; text-align: center;" class="form-control"></center>-->
<!--                    </div>-->
<!--                </div>-->
<center>
                ...
                <div class="bg-dark minus1 minus2" id="margin">
                    <div style="margin-top: 1em; margin-bottom: 1em;">
                        <img src="static/largemeal.jpg" style="width: 50%;">
...
<center>
                ...
                <div class="bg-dark minus1" id="nomargin">
                    <div style="margin-top: 1em; margin-bottom: 1em;">
                        <img src="static/amazon.jpg" style="width: 50%;">
...
<!-- 
                        <p><span id="turnmedred" style="color: #03fc4e; font-weight: bold; font-size: 40px; text-shadow: 0px 0px white;">$</span><span id="JeffBezosNetWorth" style="color: #03fc4e; font-weight: bold; font-size: 35px; text-shadow: 0px 0px white;"></span></p> -->
...
<!-- <script type="text/javascript" src="//in-page-push.com/400/3815699" data-cfasync="false" async="async"></script> -->
</body>
